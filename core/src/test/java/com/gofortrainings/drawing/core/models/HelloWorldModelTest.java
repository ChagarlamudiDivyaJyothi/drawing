 ...
 */
package com.gofortrainings.drawing.core.models;
...
import com.gofortrainings.drawing.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "drawing/components/helloworld");
